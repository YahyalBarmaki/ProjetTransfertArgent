 ...
 */
final class Version20190907004102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD compte_id INT DEFAULT NULL, CHANGE date_retrait date_retrait DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction DROP compte_id, CHANGE date_retrait date_retrait DATETIME DEFAULT NULL');
    }
}
